...
import { STYLES, FONTS } from '../../theme/index';

interface Styles {
  sliderImage: ImageStyle;
  dot: ViewStyle;
  activeDot: ViewStyle;
  backgroundImage: ImageStyle;
  mainView: ViewStyle;
  textView: TextStyle;
  headerAppIcon: ImageStyle;
  listView: ViewStyle;
  headerView: ViewStyle;
  skipView: ViewStyle;
  backView: ViewStyle;
  buttonContinue: ViewStyle;
  buttonView: ViewStyle;
  welcome: TextStyle;
  detailsText: TextStyle;
  listTitleText: TextStyle;
  listTitleTextBlue: TextStyle;
  dotView: ViewStyle;
  nextButton: ViewStyle;
  nextButtonView: ViewStyle;
}
